...
import kegiatanService from "./activities.service";

export const buatKegiatan = async (req: Request, res: Response) => {
	try {
...
export const ambilDetailKegiatan = async (req: Request, res: Response) => {
...
export const editKegiatanLengkap = async (req: Request, res: Response) => {
	const { kegiatan_id } = req.params;
	try {
...
export const editKegiatanSebagian = async (req: Request, res: Response) => {
	const { kegiatan_id } = req.params;
	try {
		const cariKegiatan = await kegiatanService.ambilDetailKegiatan(kegiatan_id);
		if (!cariKegiatan) {
...
export const hapusKegiatan = async (req: Request, res: Response) => {
	const { kegiatan_id } = req.params;
	try {
		const cariKegiatan = await kegiatanService.ambilDetailKegiatan(kegiatan_id);
		if (!cariKegiatan) {
